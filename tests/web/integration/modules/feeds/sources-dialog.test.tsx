...
let SourcesDialog: typeof import("@modules/feeds/components/follow/sources-dialog").SourcesDialog;

beforeAll(async () => {
  ({ SourcesDialog } = await import("@modules/feeds/components/follow/sources-dialog"));
});
