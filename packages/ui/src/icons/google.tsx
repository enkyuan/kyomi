...
/**
 * Renderer-neutral geometry for Google's multicolor G.
 *
 * Source catalog: https://svgl.app/directory/google
 * Usage guidance: https://developers.google.com/identity/branding-guidelines
 */
export const GoogleIconGeometry = {
  viewBox: "0 0 24 24",
  paths: [
    {
...
export type GoogleIconProps = Omit<SVGProps<SVGSVGElement>, "height" | "width"> & {
  size?: number;
};
