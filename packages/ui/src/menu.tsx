...
export function MenuSubTrigger({
  ...
  return (
    ...
    >
      {children}
      <RightFill className="ms-auto -me-0.5 opacity-80" />
    </MenuPrimitive.SubmenuTrigger>
  );
}
