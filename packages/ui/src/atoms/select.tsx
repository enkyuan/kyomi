...
import { DownFill, SelectorVerticalFill, UpFill } from "@mingcute/react";
  ...
  const defaultProps = {
    children: (
      <>
        ...
        <SelectorVerticalFill className={selectTriggerIconClassName} />
      </>
    ),
    ...
    <SelectPrimitive.Portal>
      ...
      >
        ...
        >
          ...
          >
            <UpFill className="relative size-4.5 sm:size-4" />
          </SelectPrimitive.ScrollUpArrow>
          ...
          >
            <DownFill className="relative size-4.5 sm:size-4" />
          </SelectPrimitive.ScrollDownArrow>
        </SelectPrimitive.Popup>
      </SelectPrimitive.Positioner>
    </SelectPrimitive.Portal>
...
export function SelectItem({
  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.ItemText className="col-start-2 min-w-0" data-slot="select-item-text">
        {children}
