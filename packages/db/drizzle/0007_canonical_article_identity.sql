CREATE OR REPLACE FUNCTION cronos_normalize_article_url(raw_url text)
RETURNS text
LANGUAGE plpgsql
IMMUTABLE
AS $$
...
UPDATE "feed_items"
SET "canonical_url" = cronos_normalize_article_url("link")
...
DROP FUNCTION cronos_normalize_article_url(text);
