...
/**
 * Shared DOMPurify policy for article HTML — browser (client) side.
 *
 * This mirrors `packages/worker/src/sanitization/article-html.ts`, which is
 * the canonical source used by the API/worker ingestion pipeline. If you
 * change the sanitization rules, update both files together.
 *
 * Goals:
