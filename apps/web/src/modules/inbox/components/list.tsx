...
import { InboxItemToolbarOverlay, type ActiveInboxItemToolbar } from "./item-toolbar";
import { InboxListSkeletonRows, InboxListStatic, InboxListVirtualized } from "./inbox-list-rows";
import { InboxListFilterMenu } from "./list-filter-menu";
import { FeedRefreshStatus, FeedRefreshSummary, BatchFeedRefreshStatus } from "./refresh-status";
...
import type { InboxListHeaderCount } from "../lib/count-display";
import { STATIC_LIST_ITEM_LIMIT } from "../lib/inbox-list-layout";
import type { InboxListPaginationState } from "./inbox-list-rows";

export type InboxListDisplayOptions = {
  readerFocusMode?: boolean;
  disableVirtualization?: boolean;
  showFavicons: boolean;
};

export type InboxListFilterVisibility = {
  showHidden?: boolean;
  showRead?: boolean;
};
...
interface InboxListProps {
  ...
  filter: InboxFilter;
  display: InboxListDisplayOptions;
  filterVisibility?: InboxListFilterVisibility;
...
export function InboxList({
  ...
  const [activeToolbar, setActiveToolbar] = useState<ActiveInboxItemToolbar | null>(null);
  const activeToolbarRef = useRef<ActiveInboxItemToolbar | null>(null);
