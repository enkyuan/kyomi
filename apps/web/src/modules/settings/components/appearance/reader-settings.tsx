...
const SHOW_IMAGES_SWITCH_ID = "reader-show-images";
...
export function ReaderAppearanceSettings({
  ...
  return (
    <section className="space-y-3">
      ...
      <div className="space-y-3 py-1">
        <label className="flex items-center justify-between gap-4" htmlFor={OPEN_LINKS_SWITCH_ID}>
        ...
        <label
          ...
          htmlFor={LINK_PREVIEWS_SWITCH_ID}
        >
          <span className="min-w-0">
          ...
          <Switch
            id={LINK_PREVIEWS_SWITCH_ID}
            checked={preferences.showLinkPreviews}
            onCheckedChange={(checked) => setPreferences({ showLinkPreviews: checked })}
          />
        </label>
        <label className="flex items-center justify-between gap-4" htmlFor={SHOW_IMAGES_SWITCH_ID}>
          <span className="min-w-0">
