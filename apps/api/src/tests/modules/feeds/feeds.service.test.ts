...
} from "@modules/feeds/feeds.service";
      ...
      Promise.resolve([
        {
          ...
          faviconUrl: "https://ex.com/favicon.ico" as string | null,
                ...
                Promise.resolve([
                  {
                    ...
                    faviconFetchedAt: null as Date | null,
                    createdAt: feedCreated,
                    updatedAt: feedCreated,
                    refreshStatus: "idle",
                    lastRefreshCompletedAt: null as Date | null,
                    lastRefreshFailedAt: null as Date | null,
