...
export const databaseAdapterPlugin = new Elysia({ name: "vols.rss.adapters.database" }).use(
  dbPlugin,
);
 ...
 */
export const apiV1AdapterPlugin = new Elysia({ name: "vols.rss.api.v1.adapters" })
