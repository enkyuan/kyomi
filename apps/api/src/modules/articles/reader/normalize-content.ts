...
/**
 * Builds extracted-mode reader content from persisted extracted columns.
 * Sanitization happens here again as a defense-in-depth step before returning HTML to clients.
 */
